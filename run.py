...
if __name__ == "__main__":
    ...
    # Align
    parser.add_argument(
        "--w_align", type=float, default=1.0, help="weight of alignment loss"
    )
    parser.add_argument(
        "--w_recon", type=float, default=1.0, help="weight of reconstruction loss"
    )
    parser.add_argument(
        "--local_margin", type=float, default=0.0, help="margin of alignment loss"
    )
    parser.add_argument(
        "--global_margin", type=float, default=0.0, help="margin of alignment loss"
    )
    parser.add_argument(
        "--patch_num", type=int, default=3, help="Num of patch"
    )
    parser.add_argument(
        '--layer_norm', type=int, choices=[0, 1], default=1, help='layer norm.'
    )
    parser.add_argument(
        '--pos', type=int, choices=[0, 1], default=1, help='Positional Embedding. Set pos to 0 or 1'
    )
    parser.add_argument(
        "--loc", type=int, choices=[0, 1], default=1, help="Local Alignment"
    )
    parser.add_argument(
        "--glo", type=int, choices=[0, 1], default=1, help="Global Alignment"
    )
